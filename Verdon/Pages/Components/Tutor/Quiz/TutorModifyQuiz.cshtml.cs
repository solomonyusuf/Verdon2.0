...
namespace Verdon.Pages.Components.Tutor.Quiz
{
    [Authorize(Roles = "Tutor")]
    public class TutorModifyQuizModel : PageModel
    {
        ...
        public TutorModifyQuizModel(IToastNotification toast, ApplicationDbContext context)
        {
            _toast = toast;
            _context = context;
